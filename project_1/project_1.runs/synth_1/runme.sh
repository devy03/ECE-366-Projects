...
HD_PWD='C:/Users/Devy/Desktop/ECE366_Projects/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder_struct.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fulladder_struct.tcl
