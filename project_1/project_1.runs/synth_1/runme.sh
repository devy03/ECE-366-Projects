...
HD_PWD='C:/Users/dreia/GitHubRepos/ECE-366-Projects/project_1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_RCS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_bit_RCS.tcl
