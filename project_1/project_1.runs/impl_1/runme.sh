...
HD_PWD='C:/Users/Devy/Desktop/ECE366_Projects/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder_struct.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fulladder_struct.tcl -notrace
